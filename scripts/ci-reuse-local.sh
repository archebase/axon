...
# =============================================================================
# Mirrors .github/workflows/reuse.yml for local testing.
# Checks REUSE license compliance and generates SPDX SBOM.
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "This script mirrors the GitHub Actions workflow for REUSE compliance."
            exit 0
            ;;
        *)
...
echo -e "${BLUE}=============================================${NC}"
echo -e "${BLUE}REUSE Compliance Local CI${NC}"
echo -e "${BLUE}=============================================${NC}"
echo ""
...
if reuse lint; then
    ...
    echo "     reuse annotate --year 2026 --copyright 'ArcheBase' --license 'MulanPSL-2.0' --style c <file>"
    echo ""
