...
TEST(SchemaMergerTest, MergeMultipleSchemas) {
    ...
    auto position_schema = arrow::schema({
        arrow::field("x", arrow::float64()),
        arrow::field("y", arrow::float64())
    });
    
    auto velocity_schema = arrow::schema({
        arrow::field("vx", arrow::float64()),
        arrow::field("vy", arrow::float64())
    });
...
TEST(SchemaMergerTest, MergeWithPrefixDisabled) {
    ...
    auto schema1 = arrow::schema({
        arrow::field("unique_field1", arrow::int64())
    });
    
    auto schema2 = arrow::schema({
        arrow::field("unique_field2", arrow::int64())
    });
...
TEST(SchemaMergerTest, MergeWithNullSchema) {
    ...
    topic_schemas["/valid/topic"] = arrow::schema({
        arrow::field("value", arrow::int64())
    });
...
TEST(SchemaMergerTest, CompatibleFieldsAreMerged) {
    ...
    auto schema1 = arrow::schema({
        arrow::field("data", arrow::int64(), false)
    });
...
TEST(SchemaMergerTest, CreateRecordingSchema) {
    ...
    topic_schemas["/topic1"] = arrow::schema({
        arrow::field("x", arrow::float64())
    });
...
TEST(SchemaMergerTest, GetFieldMappingMultipleTopics) {
    ...
    topic_schemas["/topic2"] = arrow::schema({
...
TEST(SchemaMergerTest, TopicNameWithSlashes) {
    ...
    topic_schemas["/robot/arm/joint1"] = arrow::schema({
        arrow::field("position", arrow::float64())
    });
...
TEST(SchemaMergerTest, TopicNameWithDashes) {
    ...
    topic_schemas["/sensor-data"] = arrow::schema({
        arrow::field("value", arrow::int64())
    });
