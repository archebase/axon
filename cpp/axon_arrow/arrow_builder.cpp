...
std::unique_ptr<ArrowBuilder> ArrowBuilderFactory::create_builder(
...
std::unique_ptr<TypedArrowBuilder<arrow::Int64Builder>>
ArrowBuilderFactory::create_int64_builder() {
  return std::make_unique<TypedArrowBuilder<arrow::Int64Builder>>(arrow::int64());
}

std::unique_ptr<TypedArrowBuilder<arrow::DoubleBuilder>>
ArrowBuilderFactory::create_double_builder() {
  return std::make_unique<TypedArrowBuilder<arrow::DoubleBuilder>>(arrow::float64());
}

std::unique_ptr<TypedArrowBuilder<arrow::StringBuilder>>
ArrowBuilderFactory::create_string_builder() {
  return std::make_unique<TypedArrowBuilder<arrow::StringBuilder>>(arrow::utf8());
}

std::unique_ptr<TypedArrowBuilder<arrow::BinaryBuilder>>
ArrowBuilderFactory::create_binary_builder() {
  return std::make_unique<TypedArrowBuilder<arrow::BinaryBuilder>>(arrow::binary());
}

std::unique_ptr<TypedArrowBuilder<arrow::BooleanBuilder>>
ArrowBuilderFactory::create_bool_builder() {
