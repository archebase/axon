...
// Include generated service headers from middleware plugins
// These are generated in middlewares/ros1 or middlewares/ros2
#if defined(AXON_ROS1)
// ROS1 service interfaces from middlewares/ros1/src/axon_recorder_plugin
...
// ROS2 service interfaces from middlewares/ros2/src/ros2_plugin
...
#elif defined(AXON_ROS2)
  // ROS 2 service servers (using middleware plugin interfaces)
