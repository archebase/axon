...
bool RecorderServiceHandler::handle_start_recording(
  const std::string& config_path, std::string& error_msg
) {
...
bool RecorderServiceHandler::handle_stop_recording(
  int32_t& flushed_batches, std::string& error_msg
) {
...
bool RecorderServiceHandler::handle_update_config(
  const std::string& config_path, std::string& error_msg
) {
...
bool RecorderServiceHandler::handle_get_status(
