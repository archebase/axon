...
TEST_F(RecordingServiceImplDirectTest, CacheConfigEmptyTaskIdFails) {
  ...
  bool result = service_impl_->handle_cached_recording_config(
    ...
    "device_01", "collector_01", "order_001", "operator1",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    success, message
  );
...
TEST_F(RecordingServiceImplDirectTest, CacheConfigNotInIdleStateFails) {
  ...
  bool result = service_impl_->handle_cached_recording_config(
    "task_002", "device_01", "collector_01", "order_001", "operator1",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    success, message
  );
...
TEST_F(RecordingServiceImplDirectTest, IsRecordingReadyAfterConfig) {
  ...
  service_impl_->handle_cached_recording_config(
    "ready_test_task", "device", "collector", "order", "operator",
    "scene", "subscene", {"skill"}, "factory", {"/topic"},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, IsRecordingReadyWhileRecording) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "recording_test", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlStartRequiresInitializedNode) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "start_test", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlPauseSuccess) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "pause_test", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlPauseWrongTaskIdFails) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "correct_task", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlPauseEmptyTaskIdFails) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "task", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlResumeSuccess) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "resume_test", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlCancelSuccess) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "cancel_test", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlCancelFromPausedSuccess) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "cancel_paused", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlFinishSuccess) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "finish_test", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, ControlClearSuccess) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "clear_test", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, StatusInitialState) {
  ...
  bool result = service_impl_->handle_recording_status(
    ...
    task_id, device_id, data_collector_id, order_id,
    operator_name, scene, subscene, skills, factory,
    active_topics, output_path, disk_usage_gb,
    duration_sec, message_count, throughput_mb_sec, last_error
  );
...
TEST_F(RecordingServiceImplDirectTest, StatusWithCachedConfig) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "status_test", "device_01", "collector_01", "order_01", "operator_01",
    "scene_01", "subscene_01", {"skill_a", "skill_b"}, "factory_01",
    {"/topic1", "/topic2"},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, StatusWhileRecording) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "recording_status", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, StatusWhilePaused) {
  ...
  std::string cache_message;
  service_impl_->handle_cached_recording_config(
    "paused_status", "device", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    cache_success, cache_message
  );
...
TEST_F(RecordingServiceImplDirectTest, FullWorkflowCacheStartPauseResumeFinish) {
  ...
  // 1. Cache config
  service_impl_->handle_cached_recording_config(
    "workflow_001", "robot", "collector", "order", "operator",
    "scene", "subscene", {"skill"}, "factory", {"/topic"},
    "", "", "",
    success, message
  );
  ...
  // 2. Pause
  service_impl_->handle_recording_control("pause", "workflow_001", success, message, task_id_response);
  EXPECT_TRUE(success);
  EXPECT_EQ(node_->get_state_manager().get_state(), RecorderState::PAUSED);
  
  // 3. Resume
  service_impl_->handle_recording_control("resume", "workflow_001", success, message, task_id_response);
  EXPECT_TRUE(success);
  EXPECT_EQ(node_->get_state_manager().get_state(), RecorderState::RECORDING);
  
  // 4. Finish
  service_impl_->handle_recording_control("finish", "workflow_001", success, message, task_id_response);
  EXPECT_TRUE(success);
  EXPECT_EQ(node_->get_state_manager().get_state(), RecorderState::IDLE);
}
...
TEST_F(RecordingServiceImplDirectTest, FullWorkflowCacheStartCancel) {
  ...
  // 1. Cache config
  service_impl_->handle_cached_recording_config(
    "cancel_workflow", "robot", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    success, message
  );
  ...
  // 2. Cancel
  service_impl_->handle_recording_control("cancel", "cancel_workflow", success, message, task_id_response);
  EXPECT_TRUE(success);
  EXPECT_EQ(node_->get_state_manager().get_state(), RecorderState::IDLE);
}
...
TEST_F(RecordingServiceImplDirectTest, FullWorkflowCacheClear) {
  ...
  // 1. Cache config
  service_impl_->handle_cached_recording_config(
    "clear_workflow", "robot", "collector", "order", "operator",
    "scene", "subscene", {}, "factory", {},
    "", "", "",
    success, message
  );
...
TEST_F(RecordingServiceImplDirectTest, MultipleCacheConfigCallsOverwrite) {
  ...
  // First cache
  service_impl_->handle_cached_recording_config(
    "first_task", "device1", "collector", "order", "operator",
    "scene1", "subscene", {}, "factory", {},
    "", "", "",
    success, message
  );
  ASSERT_TRUE(success);
  ...
  // Second cache
  service_impl_->handle_cached_recording_config(
    "second_task", "device2", "collector", "order", "operator",
    "scene2", "subscene", {}, "factory", {},
    "", "", "",
    success, message
  );
  ASSERT_TRUE(success);
