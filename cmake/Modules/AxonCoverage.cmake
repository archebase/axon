...
if(DEFINED ENV{AXON_ENABLE_COVERAGE} AND "$ENV{AXON_ENABLE_COVERAGE}" STREQUAL "1")
...
function(axon_add_coverage TARGET)
    ...
    if(NOT CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
        message(WARNING "Coverage requested but compiler is ${CMAKE_CXX_COMPILER_ID} (only GCC/Clang supported)")
        return()
    endif()
