...
│   └── axon/
│       └── middleware_abi.hpp         # Unified plugin interface (C API)
│
├── core/                              # Middleware-agnostic core
│   ├── axon_mcap/                     # MCAP writer
│   │   ├── include/
│   │   │   └── axon/mcap_writer.hpp
│   │   ├── src/
│   │   │   ├── mcap_writer_wrapper.cpp
│   │   │   └── mcap_validator.cpp
│   │   ├── test/
│   │   └── CMakeLists.txt             # Pure C++ target, no ROS deps
│   │
...
│   │   └── CMakeLists.txt             # Pure C++ target, no ROS deps
│   │
│   └── axon_uploader/                 # S3 uploader
│       ├── include/
│       │   └── axon/uploader.hpp
│       ├── src/
│       └── CMakeLists.txt             # Pure C++ target, no ROS deps
│
├── middlewares/                       # Middleware plugins
│   │
│   ├── ros1/                          # ROS1 (Noetic) plugin
│   │   ├── include/
│   │   │   └── axon/
│   │   │       └── ros1_plugin.hpp    # ROS1-specific C++ wrapper
│   │   ├── src/
│   │   │   ├── ros1_node.cpp          # ROS1 node implementation
│   │   │   ├── ros1_subscriber.cpp
│   │   │   ├── ros1_publisher.cpp
│   │   │   ├── ros1_service.cpp
│   │   │   └── ros1_plugin.cpp        # Plugin entry point
│   │   ├── CMakeLists.txt             # Builds libaxon_ros1.so
│   │   └── package.xml                # ROS1 catkin package
│   │
│   ├── ros2/                          # ROS2 plugin
│   │   ├── include/
│   │   │   └── axon/
│   │   │       └── ros2_plugin.hpp    # ROS2-specific C++ wrapper
│   │   ├── src/
│   │   │   ├── ros2_node.cpp          # ROS2 node implementation
│   │   │   ├── ros2_subscriber.cpp
│   │   │   ├── ros2_publisher.cpp
│   │   │   ├── ros2_service.cpp
│   │   │   └── ros2_plugin.cpp        # Plugin entry point
│   │   ├── CMakeLists.txt             # Builds libaxon_ros2.so
│   │   └── package.xml                # ROS2 colcon package
│   │
│   └── (future) other middlewares
│       └── ...
│
├── src/                               # Main application
│   ├── main.cpp                       # Entry point
│   ├── plugin_loader.cpp              # Plugin loading logic
│   └── CMakeLists.txt                 # Links core libs only
│
└── docs/                              # Documentation
    └── middleware-plugin-architecture-design-2025-01-11.md
```
